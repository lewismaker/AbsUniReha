...
from .datasets.REHAB24_6 import REHAB24_6_Dataset


class AdaptiveMoveDataset(Dataset):

    def __init__(self,
                 dataset_root=None,
                 movement_class='IRDS_all',
                 norm_length=True,
                 norm_orient=False,
                 aug_angle=0,
                 is_train=True):
    ...
    def __getitem__(self, index):
        ...
        label = 0, incorrect
        '''
        sample, label_cls, label = self.dataset.__getitem__(index)
